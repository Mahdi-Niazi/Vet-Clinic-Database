...
**[Vet Clinic]** is a database for storing the animals data with its name, weight, escape attempts, and neutered. 
...
```sh
  cd my-folder
  git clone https://github.com/Mahdi-Niazi/Vet-Clinic-Database.git
```
...
If you like this project please give a star to support me. 
...
I would like to thank my coding partners that helped me alot for this project.
